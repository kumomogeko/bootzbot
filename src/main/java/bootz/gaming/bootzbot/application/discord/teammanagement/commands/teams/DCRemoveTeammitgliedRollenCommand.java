...
import bootz.gaming.bootzbot.domain.teams.teammitglied.RemoveTeammitgliedRollenTeamCommand;
...
@Component
public class DCRemoveTeammitgliedRollenCommand extends AbstractRegistrableIdentifiedCommand {
    ...
    protected DCRemoveTeammitgliedRollenCommand(ExecutorFactory executorFactory, TeamService teamService) {
    ...
    public ApplicationCommandRequest getDiscordCommandRequest() {
        ...
        return ApplicationCommandRequest.builder()
                .name("removerolle")
                .description("Entfernt einem Teammitglied eine Rolle")
